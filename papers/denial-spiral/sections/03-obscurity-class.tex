...
The designs classified in the companion~\cite[\S5]{deadly-race} interpose a delay or a
veto. A large and widely shipped class
...
architectures of~\cite[\S5]{deadly-race} lack. The erasure is \emph{instantaneous and covert}:
...
Lemma~\ref{lem:drl} does not reach it, and its row in the companion's design
comparison~\cite[\S5]{deadly-race} is DR-safe
...
program, and it is the clearest statement we have found of what
...
defense is administered by patching the disclosures as they arrive. A scheme
...
analyzes under~\ref{sd:belief} is specific to the ``Internal Error'' design, and
...
tier. The perceptual-oracle-variants remark of~\cite{deadly-race} has already disposed of the tier as a
...
ineffective; the present section is that dilemma instantiated in a shipping
product.
...
appeared as guest on a self-custody program~\cite{ong-autocustodia} in which the
...
The counsel is also self-defeating in aggregate. Publicized training raises the
...
The Time-Gated Perceptual Oracle of the companion~\cite[\S4]{deadly-race} enters neither
bluff. There is nothing to erase, the deep secret having
...
requires it. The same asymmetry has an epistemic cost, taken up in \S\ref{sec:anosognosia}
