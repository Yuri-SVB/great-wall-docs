...
subset shows in the field is clause~the no-delegate-coercion clause in~\cite{deadly-race} failing: such an attacker needs no
...
\emph{did} pay, which is exactly the compliance clause~the no-delegate-coercion clause in~\cite{deadly-race}
