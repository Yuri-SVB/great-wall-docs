...
Two censoring mechanisms compound, and between them they remove the evidence that
would settle whether the Lemma's prediction is being enacted in the field.
...
diagnostic of the Lemma are the least likely to enter the registry at all. The
numerator is censored by how the terminal event is classified; the covariate is
censored by what vendors do not say.

The structure is that of \emph{anosognosia} --- the dementia patient whose disease
